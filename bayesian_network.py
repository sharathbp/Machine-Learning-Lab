...
res = bp.nodes.MultiMixture([int(input('Enter Age:'+str(ageEnum))),int(input('Enter Gender:'+str(genderEnum))),int(input('Enter Family History:'+str(familyHistoryEnum))),int(input('Enter diet:'+str(dietEnum))),int(input('Enter life style:'+str(lifeStyleEnum))),int(input('Enter cholesterol:'+str(cholestrolEnum)))],bp.nodes.Categorical,p_heartdisease).get_moments()[0][heartDiseaseEnum['Yes']]
